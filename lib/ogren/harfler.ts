...
export type Harf = {
   ...
   *
   * Bul oyununda seceneklerde YAZI YOKTUR, yalnizca bu simge gorunur:
   * simgenin Turkce adi kelimeyle ortusmek ZORUNDADIR. Kestane resmine
   * (🌰) "Ceviz" demek, cocugu "C ile baslayani bul" derken takar.
   */
  simge: string;
...
export const HARFLER: Harf[] = [
  ...
  { buyuk: "C", kucuk: "c", ornekKelime: "Civciv", simge: "🐥" },
  ...
  { buyuk: "I", kucuk: "ı", ornekKelime: "Işık", simge: "💡" },
  ...
  { buyuk: "N", kucuk: "n", ornekKelime: "Nota", simge: "🎵" },
  { buyuk: "O", kucuk: "o", ornekKelime: "Otobüs", simge: "🚌" },
  ...
  { buyuk: "V", kucuk: "v", ornekKelime: "Valiz", simge: "🧳" },
