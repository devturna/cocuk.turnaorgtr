# Boyama Sayfalarının Lisansları

Buradaki her çizgi resmin lisansı ve kaynağı `content/boyama-katalogu.json`
dosyasında girdi bazında kayıtlıdır. Aşağıdaki tablo o dosyanın özetidir.
